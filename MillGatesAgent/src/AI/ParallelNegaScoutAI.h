...
//#endif
//
//typedef enum entryFlag_parallel_t {EXACT, ALPHA_PRUNE, BETA_PRUNE} entryFlag_parallel_t;
//
//typedef struct {
//	uint8 depth;
//	entryFlag_parallel_t entryFlag;
//	eval_t eval;
//} entry_parallel;
//
//typedef struct {
...
//private:
//	ExpVector<HashSet<entry_parallel>*> * _tables;
